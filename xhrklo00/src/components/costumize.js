...
const Customize = (props) => {
    return (
        <div>
            ...
            <div className="rows">
                {/* when pressed +/- resets game board size */}
            ...
            <div className="rows">
            {/* setting up no. of ships displayed on the board */}
            <div className="col">
                <div className="rows">
            ...
            <div className = "rows">
                {/* when pressed resets ship color */}
                <p><b>Ship color</b></p>
            ...
            <div className = "rows">
                {/* when pressed resets board color */}
                <p><b>Board color</b></p>
            ...
            {/* when pressed sets board settings back to default */}
